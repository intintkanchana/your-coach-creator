...
export function DirectionSelectStep({ goal, directions, onSelect, onBack }: DirectionSelectStepProps) {
  const [selected, setSelected] = useState<string | null>(null);

  // const handleRegenerate = () => { ... } // Re-generation should be handled by parent if needed
